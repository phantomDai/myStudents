...
//	static int  counter;
  ...
  /*void generateMutant(OJClass mutant_op){
    ...
    private void generateParseTree() throws OpenJavaException {
        try {
            // 解析生成语法树
            System.out.println("start generate parse tree:"+ TimeUtil.getCurrentTime());
            comp_unit = parse(original_file);
            System.out.println("stop generate parse tree:"+ TimeUtil.getCurrentTime());
