...
public abstract class MutantsViewerPanel extends JPanel {
    ...
    void jbInit() throws Exception {
        ...
        originalSP.setPreferredSize(new Dimension(800, 400));
        mutantSP.setPreferredSize(new Dimension(800, 400));
    ...
    boolean isProperClass(String str) {
        ...
        switch (getMutantType()) {
            ...
            case MutationSystem.EM:
                ...
                break;
            case MutationSystem.CONM:
                names[0] = "concurrent_mutants";
                break;
    ...
    void showGeneratedMutantsNum(String[] name) {
        ...
        switch (getMutantType()) {
            ...
            case MutationSystem.EM:
                ...
                break;
            case MutationSystem.CONM:
                operators = MutationSystem.conm_operators; // ���ܻ�Ȳ �����̼� ������
                break;
...
//                                 break;
    ...
    /** Show source code of the selected mutant. Changed part is colored in red
     *  @param dir_name the name of class (including package name)
     *  @param mutant_log changed_line line number of mutated code against original program*/
