...
public class GenMutantsMain extends JFrame {
    ...
    /**
     * Panel for viewing details of concurrent mutants.
     */
    ConcurrentMutantsViewerPanel convPanel;

    private GenMutantsMain() {
        try {
            jbInit();
        } catch (Exception e) {
            e.printStackTrace();
    ...
    private void jbInit() throws Exception {
        ...
        convPanel = new ConcurrentMutantsViewerPanel();
        ...
        mutantTabbedPane.add("Concurrent Mutants Viewer", convPanel);
