...
public class MutationSystem extends OJSystem {
    ...
    public static final int CONM = 3; // Concurrent Mutation Operator
...
//   public static String SYSTEM_HOME = "";
    ...
    /**
     * path which concurrent mutants are put into
     */
    public static String CONCURRENT_MUTANT_PATH = "";
    ...
    /**
     * directory name for concurrent mutants
     */
    public static String CONM_DIR_NAME = "concurrent_mutants";
...
//                                             "SDL"};   
    ...
    // updated: (03/22/2018) added concurrent mutation operators
    public static String[] conm_operators = {"MXT", "MSP", "ESP", "MSF", "MXC", "MBR",
            "RTXC", "RCXC", "RNA", "RJS", "ELPA", "SAN", "ASTK", "RSTK", "ASK", "RSK", "RSB", "RVK", "RFU",
            "RXO", "EELO", "SHCR", "SKCR", "EXCR", "SPCR"};
     ...
     * Delete all class mutants generated before
     */
    public static void clearPreviousConcurrentMutants() {
        clearPreviousMutants(MutationSystem.CONCURRENT_MUTANT_PATH);
    }
    ...
    public static void clearPreviousMutants() {
        ...
        clearPreviousConcurrentMutants();
    }
    ...
    public static void recordInheritanceRelation() throws Exception {
        ...
        for (int i = 0; i < classes.length; i++) {
            ...
            try {
                ...
                System.err.println("Please check that the compiled class for the code you want to " +
                        "mutate is in the classes/ directory. Also check that the MuJava_HOME variable " +
                        "in mujava.config does not end with a trailing slash. ");
                bad[i] = true;
                classInfo[i] = new InheritanceINFO(classes[i], "");
                Runtime.getRuntime().exit(0);
            } catch (Error er) {
     ...
     *
     * @param whole_class_name of class (including package name)
     */
    public static void setJMutationPaths(String whole_class_name) {
        ...
        MutationSystem.CONCURRENT_MUTANT_PATH = MutationSystem.MUTANT_HOME
                + "/" + whole_class_name + "/" + MutationSystem.CONM_DIR_NAME;
